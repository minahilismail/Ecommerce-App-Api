    ...
    public partial class createInsertProductsCategoriesTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ELEC", new DateTime(2025, 8, 4, 11, 53, 31, 409, DateTimeKind.Local).AddTicks(7932), "Devices and gadgets", "Electronics", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "JEWEL", new DateTime(2025, 8, 4, 11, 53, 31, 409, DateTimeKind.Local).AddTicks(7946), "Jewellery and accessories", "Jewellery", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "CLOTH", new DateTime(2025, 8, 4, 11, 53, 31, 409, DateTimeKind.Local).AddTicks(7949), "Apparel and garments", "Clothing", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, "WOMEN", new DateTime(2025, 8, 4, 11, 53, 31, 409, DateTimeKind.Local).AddTicks(7951), "Women's clothing and accessories", "Women", 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, "MEN", new DateTime(2025, 8, 4, 11, 53, 31, 409, DateTimeKind.Local).AddTicks(7953), "Men's clothing and accessories", "Men", 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
